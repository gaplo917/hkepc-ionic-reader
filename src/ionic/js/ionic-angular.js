 ...
 */
    ...
    function (
      ...
      function actionSheet(opts) {
        ...
        var element = (scope.element = $compile(
          '<ion-action-sheet ng-class="cssClass" buttons="buttons"></ion-action-sheet>'
        )(scope))
            ...
            case '&':
              ...
              if (attrs[attrName] && attrs[attrName].match(RegExp(scopeName + '(.*?)'))) {
                throw new Error(
                  '& expression binding "' +
                    scopeName +
                    '" looks like it will recursively call "' +
                    attrs[attrName] +
  ...
  IonicModule.factory('$ionicClickBlock', [
    '$document',
    '$ionicBody',
    '$timeout',
   ...
   */
  IonicModule.factory('$ionicGesture', [
    function () {
      return {
        /**
         * @ngdoc method
  ...
  IonicModule.factory('$ionicHistory', [
    '$rootScope',
    '$state',
    '$location',
    '$window',
      ...
      return {
        register: function (parentScope, viewLocals) {
          ...
          if (forcedNav) {
            ...
            currentView &&
            currentView.historyId !== historyId &&
            hist.cursor > -1 &&
            hist.stack.length > 0 &&
            hist.cursor < hist.stack.length &&
            ...
            if (currentView) {
              ...
              if (
                forwardView &&
                currentView.stateId !== forwardView.stateId &&
          ...
          if (
            viewHistory.backView &&
            historyId == viewHistory.backView.historyId &&
            currentStateId == viewHistory.backView.stateId &&
            url == viewHistory.backView.url
          ) {
            for (x = 0; x < hist.stack.length; x++) {
              if (hist.stack[x].viewId == viewId) {
                action = 'dupNav'
        ...
        if (angular.isObject(configObj[namespace])) {
          ...
          providerObj[namespace] = function (newValue) {
            ...
            if (configObj[namespace] == PLATFORM) {
              ...
              var platformConfig = stringObj(
                configProperties.platform,
                ionic.Platform.platform() + platformPath + '.' + namespace
              )
  ...
  IonicModule.constant('$ionicLoadingConfig', {
    ...
    function (
      ...
      function getLoader() {
        if (!loaderInstance) {
          loaderInstance = $ionicTemplateLoader
            .compile({
  ...
  IonicModule.factory('$ionicModal', [
    ...
    function (
        ...
        show: function (target) {
          ...
          if (self.scope.$$destroyed) {
            $log.error(
              'Cannot call ' +
                self.viewType +
                '.show() after remove(). Please create a new ' +
                self.viewType +
                ' instance.'
            )
            return $$q.when()
      ...
      var createModal = function (templateString, options) {
        ...
        // Compile the template
        var element = $compile('<ion-' + options.viewType + '>' + templateString + '</ion-' + options.viewType + '>')(
          scope
        )
  ...
  IonicModule.factory('$ionicPopover', [
    '$ionicModal',
    '$ionicPosition',
    '$document',
    '$window',
    function ($ionicModal, $ionicPosition, $document, $window) {
      ...
      function positionView(target, popoverEle) {
        ...
        if (
          buttonOffset.top + buttonOffset.height + popoverHeight > bodyHeight &&
   ...
   */
  IonicModule.factory('$ionicPosition', [
    '$document',
    '$window',
  ...
  ;(function () {
     ...
     * ```
     */
    IonicModule.factory('$ionicTemplateCache', [
      '$http',
      '$templateCache',
      '$timeout',
        ...
        function ($stateProvider, $ionicConfigProvider) {
          ...
          $stateProvider.state = function (stateName, definition) {
            ...
            if (typeof definition === 'object') {
              var enabled =
                definition.prefetchTemplate !== false &&
                templatesToCache.length < $ionicConfigProvider.templates.maxPrefetch()
              if (enabled && isString(definition.templateUrl)) templatesToCache.push(definition.templateUrl)
              if (angular.isObject(definition.views)) {
                for (var key in definition.views) {
                  enabled =
                    definition.views[key].prefetchTemplate !== false &&
                    templatesToCache.length < $ionicConfigProvider.templates.maxPrefetch()
   ...
   * DEPRECATED, as of v1.0.0-beta14 -------
   */
  IonicModule.factory('$ionicViewService', [
    '$ionicHistory',
    '$log',
    function ($ionicHistory, $log) {
      function warn(oldMethod, newMethod) {
        $log.warn(
          '$ionicViewService' +
            ...
            newMethod +
            ' instead: http://ionicframework.com/docs/nightly/api/service/$ionicHistory/'
        )
      }
  ...
  IonicModule.factory('$ionicViewSwitcher', [
    ...
    function ($timeout, $document, $q, $ionicClickBlock, $ionicConfig, $ionicNavBarDelegate) {
          ...
          var switcher = {
            ...
            render: function (registerData, callback) {
              if (alreadyInDom) {
                ...
                var transitionFn =
                  $ionicConfig.transitions.views[enteringData.transition] || $ionicConfig.transitions.views.none
                ...
                if (
                  viewState(viewLocals).cache === false ||
                  viewState(viewLocals).cache === 'false' ||
            ...
            transition: function (direction, enableBack, allowAnimate) {
              ...
              var transitionFn =
                $ionicConfig.transitions.views[enteringData.transition] || $ionicConfig.transitions.views.none
              var viewTransition = transitionFn(
                enteringEle,
                leavingEle,
                enteringData.direction,
              ...
              if (!enteringData.viewId || enteringData.abstractView) {
                ...
                if (step == 'after') {
                  ...
                  if (leavingScope) {
                    ...
                    leavingData &&
                    leavingData.viewId &&
                    enteringData.stateName !== leavingData.stateName
                  ) {
      ...
      function getTransitionData(viewLocals, enteringEle, direction, view) {
        ...
        var viewTransition =
          nextTransition ||
          cachedAttr(enteringEle, 'view-transition') ||
          state.viewTransition ||
          $ionicConfig.views.transition() ||
          'ios'
        var navBarTransition = $ionicConfig.navBar.transition()
        direction =
          nextDirection || cachedAttr(enteringEle, 'view-direction') || state.viewDirection || direction || 'none'
      ...
      self.align = function (textAlign) {
        ...
        if (isBackShown && previousTitleText && $ionicConfig.backButton.previousTitleText()) {
          ...
          var availableTitleWidth =
            $element[0].offsetWidth - previousTitleWidths.titleLeft - previousTitleWidths.titleRight
  ...
  IonicModule.controller('$ionInfiniteScroll', [
    '$scope',
    '$attrs',
    '$element',
    '$timeout',
 ...
 */
  ...
  IonicModule.controller('$ionicNavBar', [
    ...
    function ($scope, $element, $attrs, $compile, $timeout, $ionicNavBarDelegate, $ionicConfig, $ionicHistory) {
      ...
      self.transition = function (enteringHeaderBar, leavingHeaderBar, viewData) {
        ...
        var transitionFn =
          $ionicConfig.transitions.navBar[viewData.navBarTransition] || $ionicConfig.transitions.navBar.none
        var transitionId = viewData.transitionId

        enteringHeaderBarCtrl.beforeEnter(viewData)

        var navBarTransition = transitionFn(
          enteringHeaderBar,
          leavingHeaderBar,
          viewData.direction,
          viewData.shouldAnimate && self.isInitialized
        )
      ...
      function deprecatedWarning(oldMethod, newMethod) {
        ...
        warn &&
          warn.call(console, 'navBarController.' + oldMethod + ' is deprecated, please use ' + newMethod + ' instead')
      }
      // END DEPRECATED -------
  ...
  IonicModule.controller('$ionicNavView', [
    '$scope',
    '$element',
    '$attrs',
    '$compile',
          ...
          if (isPrimary && viewTransition) {
            ...
            if (dragX >= windowWidth - 15) {
              ...
              associatedNavBarCtrl &&
                associatedNavBarCtrl.activeTransition &&
                associatedNavBarCtrl.activeTransition.run(step)
            }
          }
        }
        ...
        function onRelease(ev) {
          if (isPrimary && viewTransition && dragPoints && dragPoints.length > 1) {
            ...
            if (isSwipingRight && (releaseSwipeCompletion > 0.5 || velocity > 0.1)) {
              ...
              associatedNavBarCtrl &&
                associatedNavBarCtrl.activeTransition &&
                associatedNavBarCtrl.activeTransition.complete(!disableAnimation, speed)
            } else {
              ...
              associatedNavBarCtrl &&
                associatedNavBarCtrl.activeTransition &&
                associatedNavBarCtrl.activeTransition.cancel(!disableAnimation, 'fast', cancelData)
  ...
  IonicModule.controller('$ionicRefresher', [
    '$scope',
    '$attrs',
    '$element',
    '$ionicBind',
    ...
    function ($scope, $attrs, $element, $ionicBind, $timeout) {
      ...
      self.init = function () {
        ...
        if (
          !scrollParent ||
          !scrollParent.classList.contains('ionic-scroll') ||
          !scrollChild ||
   ...
   * @private
   */
  IonicModule.controller('$ionicScroll', [
    '$scope',
    'scrollViewOptions',
    '$timeout',
    '$window',
    ...
    function ($scope, scrollViewOptions, $timeout, $window, $location, $document, $ionicScrollDelegate, $ionicHistory) {
      ...
      var deregisterInstance = $ionicScrollDelegate._registerInstance(
        self,
        scrollViewOptions.delegateHandle,
        function () {
          return $ionicHistory.isActiveScope($scope)
        }
      )
  ...
  */
      ...
      self.exposeAside = function (shouldExposeAside) {
        ...
        if (self.left && self.left.isEnabled && self.right && self.right.isEnabled) {
          self.content.setMarginLeftAndRight(
            isAsideExposed ? self.left.width : 0,
            isAsideExposed ? self.right.width : 0
          )
      ...
      self.isDraggableTarget = function (e) {
        ...
        var dragIsWithinBounds =
          !shouldOnlyAllowEdgeDrag ||
  ...
  ;(function (ionic) {
      ...
      android: function (ele) {
        ...
        function run() {
          ...
          setSvgAttribute(
            circleEle,
            't',
            'scale(' + scaleX + ',1) translate(' + translateX + ',0) rotate(' + rotateLine + ',32,32)'
          )
    ...
    IonicModule.controller('$ionicSpinner', [
      '$element',
      '$attrs',
      '$ionicConfig',
    ...
    function ($scope, $element, $attrs, $compile, $rootScope) {
      ...
      function afterEnter() {
        ...
        if (isDefined($attrs.hideBackButton)) {
          deregisters.push(
            $scope.$watch($attrs.hideBackButton, function (val) {
        ...
        if (isDefined($attrs.hideNavBar)) {
          deregisters.push(
            $scope.$watch($attrs.hideNavBar, function (val) {
  ...
  IonicModule.directive('ionCheckbox', [
    '$ionicConfig',
    function ($ionicConfig) {
      return {
        restrict: 'E',
        replace: true,
        require: '?ngModel',
  ...
  IonicModule.directive('collectionRepeat', CollectionRepeatDirective).factory(
    '$ionicCollectionManager',
    RepeatManagerFactory
  )
  ...
  CollectionRepeatDirective.$inject = [
    '$ionicCollectionManager',
    '$parse',
    '$window',
    '$$rAF',
  ...
  function CollectionRepeatDirective($ionicCollectionManager, $parse, $window, $$rAF, $rootScope, $timeout) {
    ...
    function postLink(scope, element, attr, scrollCtrl, transclude) {
      ...
      if (!match) {
        throw new Error(
          "collection-repeat expected expression in form of '_item_ in " +
            "_collection_[ track by _id_]' but got '" +
            attr.collectionRepeat +
            "'."
        )
      }
      var keyExpr = match[1]
      ...
      var unlistenToExposeAside = $rootScope.$on(
        '$ionicExposeAside',
        ionic.animationFrameThrottle(function () {
      ...
      function makeChangeValidator() {
        ...
        return (self = {
          ...
          resizeRequiresRefresh: function (newWidth, newHeight) {
            var requiresRefresh =
              self.dataLength && newWidth && newHeight && (newWidth !== self.width || newHeight !== self.height)
      ...
      function refreshDimensions() {
        ...
        if (hasData && heightData.computed) {
          ...
          if (!heightData.value) {
            throw new Error(
              'collection-repeat tried to compute the height of repeated elements "' +
                repeatExpr +
        ...
        if (hasData && widthData.computed) {
          ...
          if (!widthData.value) {
            throw new Error(
              'collection-repeat tried to compute the width of repeated elements "' +
                repeatExpr +
  ...
  function RepeatManagerFactory($rootScope, $window, $$rAF) {
    ...
    return function RepeatController(options) {
      ...
      this.refreshLayout = function () {
        ...
        repeaterAfterSize =
          (parseInt(style[isVertical ? 'height' : 'width']) || 0) +
        ...
        containerNode.style[ionic.CSS.TRANSFORM] = TRANSLATE_TEMPLATE_STR.replace(PRIMARY, -beforeMargin).replace(
          SECONDARY,
          0
        )
        ...
        if (isLayoutReady && isDataReady) {
          ...
          if (
            scrollView.__scrollLeft > scrollView.__maxScrollLeft ||
      ...
      function render(forceRerender) {
        ...
        for (i = renderStartIndex; i <= renderEndIndex; i++) {
          ...
          item =
            itemsShownMap[i] ||
            (itemsShownMap[i] = itemsLeaving.length
              ? itemsLeaving.pop()
              : itemsPool.length
              ? itemsPool.shift()
              : new RepeatItem())
          ...
          if (item.secondaryPos !== dim.secondaryPos || item.primaryPos !== dim.primaryPos) {
            item.node.style[ionic.CSS.TRANSFORM] = TRANSLATE_TEMPLATE_STR.replace(
              PRIMARY,
              (item.primaryPos = dim.primaryPos)
          ...
          if (item.secondarySize !== dim.secondarySize || item.primarySize !== dim.primarySize) {
            item.node.style.cssText = item.node.style.cssText.replace(
              WIDTH_HEIGHT_REGEX,
              WIDTH_HEIGHT_TEMPLATE_STR
        ...
        if (renderEndIndex === data.length - 1) {
          ...
          afterItemsNode.style[ionic.CSS.TRANSFORM] = TRANSLATE_TEMPLATE_STR.replace(
            PRIMARY,
            dim.primaryPos + dim.primarySize
          ).replace(SECONDARY, 0)
        }
      ...
      function VerticalViewType() {
        ...
        this.getScrollValue = function () {
          return Math.max(
            0,
            Math.min(
              scrollView.__scrollTop - repeaterBeforeSize,
      ...
      function HorizontalViewType() {
        ...
        this.getScrollValue = function () {
          return Math.max(
            0,
            Math.min(
              scrollView.__scrollLeft - repeaterBeforeSize,
      ...
      function StaticViewType() {
        this.getContentSize = function () {
          return (
            this.getEstimatedPrimaryPos(data.length - 1) +
      ...
      function DynamicViewType() {
        ...
        this.getContentSize = function () {
          ...
          return (
            (dim.primaryPos + dim.primarySize || 0) +
    ...
    function ($timeout, $controller, $ionicBind, $ionicConfig) {
      return {
        ...
        compile: function (element, attr) {
          ...
          var nativeScrolling =
            attr.overflowScroll !== 'false' && (attr.overflowScroll === 'true' || !$ionicConfig.scrolling.jsScrolling())
          ...
          function prelink($scope, $element, $attr) {
            ...
            $scope.$watch(
              function () {
                return (
                  (parentScope.$hasHeader ? ' has-header' : '') +
  ...
  IonicModule.directive('exposeAsideWhen', [
    '$window',
    function ($window) {
      return {
        restrict: 'A',
        ...
        link: function ($scope, $element, $attr, sideMenuCtrl) {
          ...
          var debouncedCheck = ionic.debounce(
            function () {
  ...
  IonicModule.directive('ionInput', [
    function () {
      return {
        restrict: 'E',
        controller: [
   ...
   * ```
   */
  IonicModule.directive('ionLabel', [
    function () {
      return {
        restrict: 'E',
        require: '?^ionInput',
   ...
   */
  IonicModule.directive('inputLabel', [
    function () {
      return {
        restrict: 'C',
        require: '?^ionInput',
      ...
      function onShow(e) {
        ...
        if (scrollCtrl) {
          scrollCtrl.scrollView.__container.style.bottom =
            keyboardHeight + keyboardAttachGetClientHeight(element[0]) + 'px'
        }
      }
   ...
   */
  IonicModule.directive('ionModal', [
    function () {
      return {
        restrict: 'E',
        transclude: true,
   ...
   * ```
   */
  IonicModule.directive('navDirection', [
    '$ionicViewSwitcher',
    function ($ionicViewSwitcher) {
      return {
        restrict: 'A',
        priority: 1000,
        link: function ($scope, $element, $attr) {
   ...
   *
   */
  IonicModule.directive('ionNavTitle', [
    '$document',
    function ($document) {
      return {
        require: '^ionNavBar',
   ...
   */
  IonicModule.directive('ionPopover', [
    function () {
      return {
        restrict: 'E',
        transclude: true,
  ...
  IonicModule.directive('ionTabNav', [
    function () {
      return {
        restrict: 'E',
        replace: true,
   ...
   * ```
   */
  IonicModule.directive('ionTitle', [
    function () {
      return {
        restrict: 'E',
        compile: function (element) {
