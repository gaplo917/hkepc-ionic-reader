module.exports = {
  getQueryVariable: (query, variable) => {
    ...
    const vars = decodeURIComponent(query).split('?')[1].split('&')
  ...
  isProxy: () => !window.location.href.startsWith('file://') && !window.location.href.startsWith('ms-appx-web://') && !window.Bridge
}
