...
export class CommonInfoExtractRequest {
  static get NAME() {
    return 'CommonInfoExtractRequest'
  }
...
export class NotificationBadgeUpdateRequest {
  static get NAME() {
    return 'NotificationBadgeUpdateRequest'
  }
...
export class PostDetailRefreshRequest {
  static get NAME() {
    return 'PostDetailRefreshRequest'
  }
}

export class PostListRefreshRequest {
  static get NAME() {
    return 'PostListRefreshRequest'
  }
}
...
export class AndroidBottomFixRequest {
  static get NAME() {
    return 'AndroidBottomFixRequest'
  }
